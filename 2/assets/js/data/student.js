        document.addEventListener('DOMContentLoaded', () => {
           ...
           let studentData = {
                '2024-2025': {
                    'Fall': [
                        { id: 'S24001', name: 'Alice Smith', class: 'Math 101', status: 'Active', img: 'assets/img/logo/user.png', dob: '2010-01-15', guardian: 'Mr. John Smith', contact: 'john.smith@example.com' },
                        { id: 'S24002', name: 'Bob Johnson', class: 'Science 101', status: 'Active', img: 'assets/img/logo/user.png', dob: '2011-03-22', guardian: 'Ms. Emily Johnson', contact: 'emily.j@example.com' },
                        { id: 'S24003', name: 'Charlie Brown', class: 'History 101', status: 'Active', img: 'assets/img/logo/user.png', dob: '2010-07-01', guardian: 'Mrs. Lucy Brown', contact: 'lucy.b@example.com' },
                        { id: 'S24004', name: 'Diana Prince', class: 'English 101', status: 'Active', img: 'assets/img/logo/user.png', dob: '2009-11-05', guardian: 'Mr. Wayne Prince', contact: 'wayne.p@example.com' },
                        { id: 'S24005', name: 'Eve Adams', class: 'Math 101', status: 'Active', img: 'assets/img/logo/user.png', dob: '2011-02-10', guardian: 'Mr. David Adams', contact: 'david.a@example.com' },
                        { id: 'S24006', name: 'Frank White', class: 'Science 101', status: 'Active', img: 'assets/img/logo/user.png', dob: '2010-09-18', guardian: 'Mrs. Susan White', contact: 'susan.w@example.com' },
                        { id: 'S24007', name: 'Grace Hopper', class: 'History 101', status: 'Active', img: 'assets/img/logo/user.png', dob: '2009-04-30', guardian: 'Mr. Allan Hopper', contact: 'allan.h@example.com' },
                        { id: 'S24008', name: 'Henry Ford', class: 'Math 101', status: 'Suspended', img: 'assets/img/logo/user.png', dob: '2010-06-01', guardian: 'Mrs. Betty Ford', contact: 'betty.f@example.com' },
                        { id: 'S24009', name: 'Ivy Green', class: 'English 101', status: 'Active', img: 'assets/img/logo/user.png', dob: '2011-08-25', guardian: 'Mr. Robert Green', contact: 'robert.g@example.com' },
                        { id: 'S24010', name: 'Jack Black', class: 'Art 101', status: 'Active', img: 'assets/img/logo/user.png', dob: '2010-03-10', guardian: 'Ms. Kelly Black', contact: 'kelly.b@example.com' },
                    ],
                    'Spring': [
                        { id: 'S24001', name: 'Alice Smith', class: 'Math 101', status: 'Active', img: 'assets/img/logo/user.png', dob: '2010-01-15', guardian: 'Mr. John Smith', contact: 'john.smith@example.com' },
                        { id: 'S24002', name: 'Bob Johnson', class: 'Science 101', status: 'Active', img: 'assets/img/logo/user.png', dob: '2011-03-22', guardian: 'Ms. Emily Johnson', contact: 'emily.j@example.com' },
                        ...
                        { id: 'S24005', name: 'Eve Adams', class: 'Math 101', status: 'Active', img: 'assets/img/logo/user.png', dob: '2011-02-10', guardian: 'Mr. David Adams', contact: 'david.a@example.com' },
                        { id: 'S24008', name: 'Henry Ford', class: 'Math 101', status: 'Suspended', img: 'assets/img/logo/user.png', dob: '2010-06-01', guardian: 'Mrs. Betty Ford', contact: 'betty.f@example.com' },
                        { id: 'S24011', name: 'Karen Kim', class: 'Art 101', status: 'Active', img: 'assets/img/logo/user.png', dob: '2010-10-20', guardian: 'Mr. Paul Kim', contact: 'paul.k@example.com' },
                    ],
                    'FullYear': []
                },
                '2023-2024': {
                    'FullYear': [
                        { id: 'S23001', name: 'Old Student A', class: 'Math 101', status: 'Graduated', img: 'assets/img/logo/user.png', dob: '2008-05-10', guardian: 'Mr. Old Guardian A', contact: 'old.a@example.com' },
                        { id: 'S23002', name: 'Old Student B', class: 'History 101', status: 'Graduated', img: 'assets/img/logo/user.png', dob: '2008-09-01', guardian: 'Ms. Old Guardian B', contact: 'old.b@example.com' },
                        { id: 'S23003', name: 'Student C (Left)', class: 'Science 101', status: 'Inactive', img: 'assets/img/logo/user.png', dob: '2009-02-28', guardian: 'Mr. New Guardian C', contact: 'new.c@example.com' },
                    ]
                }
            };
                    ...
                    currentStudents.forEach((student, index) => {
                        ...
                        row.innerHTML = `
                            ...
                            <td class="student-info">
                                <img src="${student.img || 'assets/img/logo/user.png' + student.name.charAt(0)}" alt="${student.name}">
                ...
                studentTableBody.querySelectorAll('.view-profile-btn').forEach(button => {
                    button.addEventListener('click', function() {
                        ...
                        if (student) {
                            ...
                            viewProfileImg.src = student.img || 'assets/img/logo/user.png' + student.name.charAt(0);
