        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            let teacherData = {
                '2024-2025': {
                    'Fall': [
                        { id: 'T24001', name: 'Dr. Jane Smith', department: 'Science', status: 'Active', img: 'assets/img/logo/user.png', specialization: 'Physics', contact: 'jane.s@edudash.com', dateHired: '2020-08-15' },
                        { id: 'T24002', name: 'Mr. John Doe', department: 'Mathematics', status: 'Active', img: 'assets/img/logo/user.png', specialization: 'Calculus', contact: 'john.d@edudash.com', dateHired: '2019-09-01' },
                        { id: 'T24003', name: 'Ms. Emily White', department: 'English', status: 'Active', img: 'assets/img/logo/user.png', specialization: 'Literature', contact: 'emily.w@edudash.com', dateHired: '2021-01-10' },
                        { id: 'T24004', name: 'Prof. Alex Green', department: 'History', status: 'On Leave', img: 'assets/img/logo/user.png', specialization: 'World History', contact: 'alex.g@edudash.com', dateHired: '2018-03-01' },
                        { id: 'T24005', name: 'Ms. Sarah Brown', department: 'Arts', status: 'Active', img: 'assets/img/logo/user.png', specialization: 'Visual Arts', contact: 'sarah.b@edudash.com', dateHired: '2022-09-01' },
                        { id: 'T24006', name: 'Mr. Chris Davis', department: 'Science', status: 'Active', img: 'assets/img/logo/user.png', specialization: 'Biology', contact: 'chris.d@edudash.com', dateHired: '2020-01-05' },
                        { id: 'T24007', name: 'Dr. Maria Lopez', department: 'Mathematics', status: 'Active', img: 'assets/img/logo/user.png', specialization: 'Algebra', contact: 'maria.l@edudash.com', dateHired: '2017-08-01' },
                    ],
                    'Spring': [
                        { id: 'T24001', name: 'Dr. Jane Smith', department: 'Science', status: 'Active', img: 'assets/img/logo/user.png', specialization: 'Physics', contact: 'jane.s@edudash.com', dateHired: '2020-08-15' },
                        { id: 'T24002', name: 'Mr. John Doe', department: 'Mathematics', status: 'Active', img: 'assets/img/logo/user.png', specialization: 'Calculus', contact: 'john.d@edudash.com', dateHired: '2019-09-01' },
                        ...
                        { id: 'T24005', name: 'Ms. Sarah Brown', department: 'Arts', status: 'Active', img: 'assets/img/logo/user.png', specialization: 'Visual Arts', contact: 'sarah.b@edudash.com', dateHired: '2022-09-01' },
                        { id: 'T24006', name: 'Mr. Chris Davis', department: 'Science', status: 'Active', img: 'assets/img/logo/user.png', specialization: 'Biology', contact: 'chris.d@edudash.com', dateHired: '2020-01-05' },
                        { id: 'T24008', name: 'Mr. Peter Jones', department: 'History', status: 'Active', img: 'assets/img/logo/user.png', specialization: 'Ancient History', contact: 'peter.j@edudash.com', dateHired: '2023-01-01' },
                        { id: 'T24009', name: 'Dr. Lisa King', department: 'Science', status: 'Active', img: 'assets/img/logo/user.png', specialization: 'Chemistry', contact: 'lisa.k@edudash.com', dateHired: '2023-09-15' },
                    ],
                    'FullYear': [] // Will be dynamically combined
                },
                '2023-2024': {
                    'FullYear': [ // For simplicity, only full year for previous academic year
                        { id: 'T23001', name: 'Mr. David Lee', department: 'Mathematics', status: 'Retired', img: 'assets/img/logo/user.png', specialization: 'Geometry', contact: 'david.l@edudash.com', dateHired: '2000-09-01' },
                        { id: 'T23002', name: 'Ms. Laura Chen', department: 'English', status: 'Active', img: 'assets/img/logo/user.png', specialization: 'Grammar', contact: 'laura.c@edudash.com', dateHired: '2015-01-10' },
                    ]
                }
            };
                ...
                teacherTableBody.querySelectorAll('.view-profile-btn').forEach(button => {
                    button.addEventListener('click', function() {
                        ...
                        if (teacher) {
                            ...
                            viewProfileImg.src = teacher.img || 'assets/img/logo/user.png' + teacher.name.charAt(0);
